...
class ContentAware {
     ...
     */
    public function crop($imagePath, $targetWidth, $targetHeight, $extension = 'jpg', $compressionQuality = 85) {
        try {
        ...
        $image->resizeImage($crop['width'], $crop['height'], Imagick::FILTER_CATROM, 1);
        ...
        $image->gaussianBlurImage(0.05, 0);
        $image->stripImage();
        return $image;
    }
